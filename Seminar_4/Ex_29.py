...
#            смышлеными. Никто из ребят не смог до конца сделать это задание. Они решили так: у кого будет меньше
#            ошибок в коде, тот и выиграл спор. За помощью товарищи обратились к Вам, студентам.

max_num = 0
while number := int(input("Введите очередное число последовательности: ")):
    if number > max_num:
        max_num = number
print(max_num)
